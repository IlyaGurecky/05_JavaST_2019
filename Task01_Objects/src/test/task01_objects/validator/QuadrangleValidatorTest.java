...
public class QuadrangleValidatorTest {
    ...
    public void testIsQuadrangle() {
        List<Double> points = new ArrayList<>(Arrays.asList(2.0, 2.0, 0.0, 1.0,
                2.0, 3.0, -1.0, 0.0));
    ...
    public void testIsNotQuadrangle() {
        List<Double> points = new ArrayList<>(Arrays.asList(-0.44, 1.56,
                0.96345698, 2.96345698, 2.224, 4.224, 0.1963, 2.1963));
        QuadrangleValidator validator = new QuadrangleValidator();
        boolean isQuadrangle = validator.isQuadrangle(points);
