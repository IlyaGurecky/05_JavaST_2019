...
/**
 * Specification class. Used to sort quadrangles by first point X.
 */
public class SortByFirstPointXQuadrangleSpecification implements
    ...
    public Comparator<Quadrangle> specifiedComparator() {
        return Comparator
                .comparingDouble(value -> value.getPoint(0).getX());
    }
}
