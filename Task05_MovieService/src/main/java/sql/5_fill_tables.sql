...
VALUES (1, 'Зеленая миля', '1999-12-06', 1, 7, 'greenMile.jpg', 'Режиссер: Фрэнк Дарабонт. Картина снята по одноименному роману Стивена Кинга. Однажды в
...
человечностью. Так же со временем выясняется, что Джон является обладателем
 удивительного дара – способностью'),
       ...
       (4, 'Властелин колец: Две крепости', '2002-12-05', 4, 3, NULL, NULL),
       (5, 'Властелин колец: Возвращение Короля', '2003-12-01', 4, 3, NULL,
        NULL),
       ...
       (7, 'Гарри Поттер и Тайная комната', '2002-03-11', 2, 3, NULL, NULL),
       (8, 'Назад в будущее', '1985-07-03', 2, 3, NULL, NULL),
       (9, 'Мальчишник в Вегасе', '2009-05-30', 1, 1, NULL, NULL),
